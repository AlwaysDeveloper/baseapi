...
const { HTTP_CONSTANT, token, A } = require('@mvp-rockets/namma-lib');
...
const { logError } = require('@mvp-rockets/namma-lib/src/lib/utilities/logger');
const AutoImportApis = require('./autoimport');
...
class Router {
    ...
    setApp(app, options = {
        ...
        new AutoImportApis(options.route);
    }

    withSecurity() {
        return new PreRequestHandler(new RestHandler(this, this.app), this.security);
    }
